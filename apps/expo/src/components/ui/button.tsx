  ...
  "web:ring-offset-background web:transition-colors web:focus-visible:outline-none web:focus-visible:ring-2 web:focus-visible:ring-ring web:focus-visible:ring-offset-2 group flex items-center justify-center rounded-md",
  {
    variants: {
      variant: {
        ...
        success: "web:hover:opacity-90 bg-green-600 active:opacity-90",

        outline:
          "web:hover:bg-accent web:hover:text-accent-foreground border border-input border-primary active:bg-accent dark:active:bg-card",
        secondary:
          "web:hover:opacity-80 bg-secondary active:opacity-80 dark:bg-gray-900",
        ghost:
